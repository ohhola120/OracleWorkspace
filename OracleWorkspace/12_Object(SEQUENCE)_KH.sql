/* 
    ...
    *캐시메모리란?
    ...
    훨씬 속도가 빠르다. 단, 접속이 끊기고 나서 재접속시 기존에 생성되어있던 값들은 사라진다.
*/

CREATE SEQUENCE SEQ_TEST;

-- 현재 계정이 소유하고있는 시퀀스에대한 정보를 조회할수 있는 데이터 딕셔너리.
...
SELECT SEQ_EMP_NO.NEXTVAL FROM DUAL;  -- 315
SELECT SEQ_EMP_NO.CURRVAL FROM DUAL;  -- 315 + 10 = 325

DROP SEQUENCE SEQ_EMP_NO;
--------------------------------------------------------------------------------
-- 실습문제
-- 매번 새로운 사번이 발생되는 시퀀스 생성 (시퀀스명 SEQ_EMP_EID)
-- 시작값은 300, 증가값은 1, 최대값은 400
-- 시퀀스 생성 후 시퀀스를 활용하여 2명의 사원정보 추가.
-- 사원정보는 임의로 생성하기.
...
INSERT INTO EMPLOYEE(EMP_ID,EMP_NAME,EMP_NO,JOB_CODE,SAL_LEVEL)
VALUES(SEQ_EMP_EID.NEXTVAL,'고길동','123456-1234567','J2','S1');
